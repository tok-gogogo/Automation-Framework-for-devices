...
if __name__ == '__main__':
    ...
    #os.startfile('C:\\Program Files\\EPA\\EPA.exe')
    time.sleep(5)
    
    #EAPWindow = findTopWindow(wantedText='Wireshark: Capture Options')
    #print EAPWindow
    #activateMenuItem(EAPWindow,['Capture','Interfaces'])
    ...
    if win_version in ["NT"]:
        activateMenuItem(notepadWindow, ['文件', '打开'])
