...
class reporter:
    ...
    def write(self,project,report):
        ...
        if report['result'] == True:
            s = s + 'result:\tTrue' + '\treport:\t' + report['report'] + '\n'
        else:
            s = s + 'result:\tFalse'+'\treport:\t' + report['report'] + '\n'
        f.write(s)
        f.close()
    def append(self,project,report):
        ...
        f.write('[' + project + ']' + '\n')
        if report['result'] == True:
            s = 'result:\tTrue'+'\treport:\t'+report['report']+'\n'
        else:
            s = 'result:\tFalse'+'\treport:\t'+report['report']+'\n'
        f.write(s)
        f.close()
...
if __name__ == "__main__":
    ...
    EMS = ur'C:\Documents and Settings\dell\桌面\EMS-client(2).exe'
    license_path = ur'C:\Documents and Settings\dell\桌面\LISENCE(4).KEY'
