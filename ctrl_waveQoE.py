#-*- coding: UTF-8 -*-
#-----------------------------------------------------------------------------
# Name:        ctrl_waveQoE.py
# Purpose:     control veriwave waveQoE to execute test case.
#
# Author:      gongke
#
# Created:     2013/05/20
# RCS-ID:      $Id: ctrl_waveQoE.py $
# Copyright:   (c) 2006
...
#----------------------------------------------------------------------------
WAVEQOE_EXE_PATH = r'C:\Program Files\VeriWave\WaveQoE\waveQoE.exe'
WAVEQOE_RESULT_DIR = r'C:\Documents and Settings\liugang\VeriWave\WaveQoE\Results'
WAVEQOE_CLASS = 'QWidget'
PDF_CLASS = 'AdobeAcrobat'

#----------------------------------------------------------------------------
#ERROR LIST
ERR_NO_0001 = 'error_no_1:you have pywintypes errors when you try to get hwnd of waveQoE window for first time.'
ERR_NO_0002 = 'error_no_2:you have pywintypes errors when you try to get hwnd of waveQoE window.'
...
ERR_NO_0005 = 'error_no_5:you can not open waveQoE.'
...
ERR_NO_0009 = 'error_no_9:you can not control waveQoE window and close it.'
...
class ctrl_waveQoE:
    ...
    #-----------------------------------------------------------------------------
    # Name:         waveQOE
    # purpose:      control waveQoE to execute test case.
    ...
    # Created:      2013/05/20
    #-----------------------------------------------------------------------------   
    def waveQOE(self,conf_file_dir_1,dst_1,my_wait_time_1):
    ...
    #-----------------------------------------------------------------------------
    # Name:         init_waveQoE
    # purpose:      initialize waveQoE.If any waveQoE window exists,close it.
    # explain:     
    # Author:       gongke
    #
    # Created:      2013/05/20
    ...
    # Created:      2013/05/20
    #----------------------------------------------------------------------------- 
    def run_waveQoE(self):        
        #click the start button to run test.
        self.myobj.Mouse_LB_D(str_app = WAVEQOE_CLASS,lb_dx = '215',lb_dy = '80',Flag = '1')
        return True
    ...
    def find_newest_dir(self):
        ...
        list_results_dir = os.listdir(WAVEQOE_RESULT_DIR)
        st = list_results_dir.sort(key = lambda fn: os.path.getmtime(WAVEQOE_RESULT_DIR + "\\" + fn) if not os.path.isdir(WAVEQOE_RESULT_DIR + "\\" + fn) else 0)
        d = datetime.datetime.fromtimestamp(os.path.getmtime(WAVEQOE_RESULT_DIR + "\\" + list_results_dir[-1]))
        print ('last dir is '+list_results_dir[-1])  
        
        list_newest_dir = os.listdir(WAVEQOE_RESULT_DIR + '\\' + list_results_dir[-1])
        ...
        src = WAVEQOE_RESULT_DIR + "\\" + list_results_dir[-1] + "\\" + report
...
if __name__ == '__main__':    
    myclass=ctrl_waveQoE()
    myclass.waveQOE(conf_file_dir_1 = r'C:\Program Files\VeriWave\WaveQoE1\11n.wml',dst_1 = 'e:\gongke-result',my_wait_time_1 = '600')
    #myclass.waveQOE(conf_file_dir_1 = r'C:\Program Files\VeriWave\WaveQoE1\111111n.wml',dst_1 = 'e:\gongke-result',my_wait_time_1 = '400')
    #myclass.waveQOE(conf_file_dir_1 = r'C:\Program Files\VeriWave\WaveQoE1\0514.wml',dst_1 = 'e:\gongke-result',my_wait_time_1 = '300')
