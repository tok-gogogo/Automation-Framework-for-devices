...
# Licence:     <0.0.1>
#-----------------------------------------------------------------------------
#<0.0.2>: add serial_open() function by chen sheng cong,@2013/03/05,
...
class clsSerial():
    ...
    def __init__(self,port = "1", baudrate="115200"):
        ...
        #self.result = False
        self.m_strMyPort = string.atoi(port) - 1
        self.m_strMybaudrate = string.atoi(baudrate)      
